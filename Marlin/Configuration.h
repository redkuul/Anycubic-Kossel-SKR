...
// Anycubic Probe version 1 or 2 (Luuks) see README.md; 0 for no probe; -1 for sensorless
...
#define STRING_CONFIG_H_AUTHOR "Luuk" // Who made the changes.
...
#define Z_PROBE_FEEDRATE_FAST (50*60) //Luuk: was 100*60 in old config
...
#define HOMING_FEEDRATE_MM_M { (0), (0), (100*60) }
